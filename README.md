...
- [tonyliugd/monitoringStudy](https://github.com/tonyliugd/-) - 监控算法参考
- [MediaPipe](https://google.github.io/mediapipe/) - 姿态检测
- [TensorFlow Lite](https://www.tensorflow.org/lite) - 边缘 AI
- [CoreML](https://developer.apple.com/coreml/) - iOS AI 加速
